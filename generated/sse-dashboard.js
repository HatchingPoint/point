...
export async function* streamMetricPulsesLine() {
  yield* streamLinesRaw("sh", ["-c", "i=0; while [ $i -lt 12 ]; do echo pulse-$i; i=$((i+1)); sleep 0.2; done"], []); // @point 12
}

export function metricPulsesSseConnect() {
  return;
}

export function metricPulsesSseDisconnect() {
  return null; // @point 18
}

export function livePulseFeedView() {
}
...
export function homePage() {
  return livePulseFeedView();
}

export async function serveSseDashboardCommand() {
