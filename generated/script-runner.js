...
export async function* runDemoShellLine() {
  yield* streamLinesRaw("sh", ["examples/app/script-runner/demo.sh"], []); // @point 13
}

export function runnerStreamRouteConnect() {
  return;
}

export function runnerStreamRouteDisconnect() {
  return null; // @point 19
}

export function scriptTerminalPanelView() {
}

export function scriptRunnerPage() {
  return scriptTerminalPanelView();
}

export async function serveScriptRunnerCommand() {
