...
On the public docs site, the **Agent context demo** on [Proof of concept](/point/concepts/proof-of-concept#agent-context-demo) walks through a real repair scenario using output from `@hatchingpoint/point@0.2.6`:
